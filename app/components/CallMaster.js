"use client"
import styles from '../styles/callmaster.module.scss';
import Link from "next/link";
import {Form} from "@/app/components/form";
import {useState} from "react";

export const CallMaster = () => {
    const [state, setState] = useState(false);
    return (
        <div className={styles.callmaster}>
            {
                state && (
                    <>
                        <div style={{
            ...
            <div className={styles.callmaster__container}>
                <div className={styles.container}>
                    <div className={styles.callmaster__box}>
                        <h2 className={styles.callmaster__title}>
                            Как вызвать мастера?
                        </h2>
                        <p className={styles.callmaster__text}>
                            ...
                            общение, то позвоните по личному телефону <a href='tel:+79138483897'
                                                                         className={styles.purple}>+7-913-848-38-97.</a>
				...
				c-4.472,2.64-9.312,4.64-14.392,5.952l-6,1.536V312H80v-16.296l-6-1.544C68.92,292.84,64.08,290.84,59.608,288.2z"/>
                        ...
                        <p className={styles.callmaster__text}>
                            ...
                            марку аппарата и примерный возраст
                            <span className={styles.organe}>“Индезит, Атлант, Samsung, LG, LIEBHERR, SMEG, Whirlpool, AEG, Miele, Electrolux, XAISER!” </span>
                            и "сравните с договором! *сформулируйте неисправность,
                            послушайте работает ли мотор-компрессор. Эти сведения
                            позволят быстро принять заявку и оперативно приехать к вам.
                        </p>
                    </div>
                </div>
            </div>
