...
export const Footer = () => {
    ...
    return (
        <>
            {
                state && (
                    <div style={{display: "flex", justifyContent: "center", position: "absolute", margin: "0 auto", width: "100%"}}>
